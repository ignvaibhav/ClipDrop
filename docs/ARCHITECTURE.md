# ClipDrop Architecture (v0.1)

## Components

- `extension/` injects UI into YouTube pages and submits download requests.
- `app/src-tauri/` runs a local Axum API inside a Tauri tray app.
