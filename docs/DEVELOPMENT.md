...
```
INFO clipdrop_desktop::server: ClipDrop API listening on http://127.0.0.1:49152
```
...
5. The **ClipDrop** button should appear in the action bar
...
- All injected DOM elements use `clipdrop-` class prefix.
